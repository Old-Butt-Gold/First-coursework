...
Type
    ...
    public
        ...
        Procedure ChangeBitMapInKilledList(Current: PKilledPiecesList; Dir, Path: String);
...
Procedure TLinkedUnit.ChangeBitMapInKilledList(Current: PKilledPiecesList; Dir, Path: String);
Begin
...
Begin
    ...
    While Temp <> Nil do
    Begin
        ChangeBitMapInKilledList(Temp, Dir, GetNameOfIcon(Temp^.ChessType));
        ACanvas.Rectangle(Temp^.PosPaint.X, Temp^.PosPaint.Y, Temp^.PosPaint.X + 80, Temp^.PosPaint.Y + 80);
